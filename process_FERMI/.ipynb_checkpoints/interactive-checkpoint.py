...
class AzimuthalIntegrationCenter:
    ...
    def __init__(self, im, ai, c0=None, c1=None, mask = None, **kwargs):
        ...
        w_c0 = ipywidgets.FloatSlider(value=c0,min=im.shape[-2]/2-np.round(im.shape[-2]/6),max=3/2*im.shape[-2],step=2, description="y-center",layout=ipywidgets.Layout(width="500px"))
        w_c1 = ipywidgets.FloatSlider(value=c1,min=im.shape[-1]/2-np.round(im.shape[-1]/6),max=3/2*im.shape[-1],step=2, description="x-center",layout=ipywidgets.Layout(width="500px"))
